...
select 
    ...
    pm.P_CODE 상품코드,
    pd.p_name 상품명,
    TO_CHAR(pd.p_price, '99,999') 상품가,  --TO_CHAR '99,999' 표현 , 찍는거
    pm.p_qty 구매수량,
    ...
    TO_CHAR(DECODE(SUBSTR(pm.p_date, 5, 4), '0101', pm.p_total*200, pm.p_total*100), '9,999,999') 새해2배적립포인트,-- DECODE 사용
    gf.gname 사은품명,
